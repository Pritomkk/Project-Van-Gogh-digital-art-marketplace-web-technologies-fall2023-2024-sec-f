                ...
                <tr>
                    <td>
                        ...
                        <center><h2>ChangeAdminPassword</h2></center>
                            <form action="../Controller/ChangepassAdminCheck.php" method="post" enctype="">
                                <fieldset>
                                    <legend align="center"><h4>VAN GOGH</h4></legend>
                                    ...
                                    Retype New Password:
                                    <input type="password" name="RenewPassword" value="" /> <br><br>
                                    </hr>
