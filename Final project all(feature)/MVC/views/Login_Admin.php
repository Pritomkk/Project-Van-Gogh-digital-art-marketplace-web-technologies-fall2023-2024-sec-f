...
<div class="container">
        <div class="img">
            <img src="../assets/Logina.jpg" class="img">
        </div>
                <div class="Login">
                <h1>Admin Login</h1>
                <form method="post" action="../controllers/LoginCheckAdmin.php" onsubmit="return Form()">         
                    Email:
                    ...
                    <a href="../views/forgetpassadmin.php">Forgot Password?</a><br><br>
                    ...
                    <p><i>Don't have an account </i>
                        <a href="../views/AdminReg.php">Sign Up</a></p>
                </form>
            </div>
