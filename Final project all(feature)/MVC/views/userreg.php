...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/regtration.css">
</head>
<body>
<header>
...
<h3>User Registration</h3>
    <div class="container">
        ...
        <form method="post" action="../controllers/uaregcheck.php" enctype="multipart/form-data" name="Reg" onsubmit="return Form()">    
                    <input type="hidden" id="userRole" class="input_box" name="userRole" value="User">
                    ...
                    <input type="checkbox" id="terms" name="terms" /> I accept the <a href="../views/Terms&ConditionUser.Html">Terms and Conditions</a><br><br>
