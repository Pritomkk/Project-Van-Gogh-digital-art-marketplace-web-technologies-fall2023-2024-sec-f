function loadalert_Messages_from_user() {
    ...
    xhr.open('GET', '../controllers/loadalert_message_from_User.php', true);
...
function sendMessageAdmin() {
    ...
    if (message !== '') {
        ...
        let xhr = new XMLHttpRequest();
        xhr.open('POST', '../controllers/s_m_support_Artist_to_Admin.php', true);
...
function NewConversation(UserName) {
    ...
    window.location.href = '../views/Support_Admin_to_user.php?Userindentity=' + encodedUserName;
}
...
function sendMessageUser(UserName) {
    ...
    if (message !== '') {
        let xhr = new XMLHttpRequest();
        xhr.open('POST', '../controllers/s_m_support_Admin_to_User.php', true);
