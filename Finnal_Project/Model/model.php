                    ...
                    $Joiningdob, $Usertype, $ProfilePicture ,$Status)
{
    ...
    {   
        $insertQuery = "INSERT INTO userartist (FirstName, LastName, UserName, Email, Password,
                             DateofBirth, Gender, PhoneNumber, JoiningDate, Usertype, ProfilePicture,Status) 
