...
function updateApprovalStatus(UserName, status, message, buttonId) {
    ...
    xhr.open('GET', '../Controller/Update_Approval_Status_User.php?UserName=' + encodedUserName + '&status=' + encodedStatus, true);
...
function checkNotifications() {
    let xhr = new XMLHttpRequest();
    xhr.open('GET', '../Controller/User_Approval_check.php', true);
