function show1() 
{
    ...
    window.location.href="../View/artist_varification.php";
...
function show2() 
{
   ...
   if(show_verificatio_status.style.display === "none" ||show_verificatio_status.style.display === "")
   {
    ...
    xhttps.open('GET',"../Controller/Show_Verification_Status_Artist.php",true)
...
function show5() 
{
    ...
    window.location.href="../View/support_Artist_to_Admin.php";
